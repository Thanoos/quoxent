...
namespace quoxent.Networks.Rules
{
   /// <summary>
   /// Checks if <see cref="quoxentMain"/> network block's header has a valid block version.
   /// </summary>
   public class quoxentHeaderVersionRule : HeaderVersionRule
   {
      /// <inheritdoc />
